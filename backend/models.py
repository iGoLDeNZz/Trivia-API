...
database_path = "postgres://{}/{}".format(database_setup['port'], database_setup["database_name_production"])
...
def setup_db(app, database_path=database_path):
    ...
    app.config["SQLALCHEMY_TRACK_MODIFICATIONS"] = database_setup["SQLALCHEMY_TRACK_MODIFICATIONS"]
    db.app = app
    db.init_app(app)
    db.create_all()
